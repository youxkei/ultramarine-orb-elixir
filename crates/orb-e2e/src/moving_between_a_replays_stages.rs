...
/// reaches the new stage before it returns. See `the_frame_a_scene_is_built_on.rs`.
...
/// and the number this waits out cannot drift apart — see [`crate::fake::th06::SHAKE_FRAMES`], which is
/// also the whole of what a shake left to run out takes.
const SHAKE_FRAMES: u32 = crate::fake::th06::SHAKE_FRAMES as u32;
