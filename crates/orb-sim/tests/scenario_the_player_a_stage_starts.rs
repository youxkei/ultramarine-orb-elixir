...
//! `scenario_a_clear_on_demand.rs`'s subject and would answer this one's question for it.

mod fake;

use fake::th06::{FRESH, Fake, INVULNERABLE_AFTER_SPAWNING, the_run};
...
fn a_stage_starts_its_player_invulnerable_with_the_first_frame_already_spent() {
    in_its_own_process(|| {
        ...
        // already been updated on — see `scenario_the_frame_a_scene_is_built_on.rs`.
